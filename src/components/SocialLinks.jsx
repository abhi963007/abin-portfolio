...
const socialLinks = [
  {
    ...
    icon: Linkedin,
    url: "https://www.linkedin.com/in/abin-varghese-847603252?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@abinvarghese",
    icon: Instagram,
    url: "https://www.instagram.com/abinvarghese?igsh=anpwNnVia2hpYzNm",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@abinvarghese",
    icon: Youtube,
    url: "https://www.youtube.com/@abinvarghese",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Abinvarghese22",
    icon: Github,
    url: "https://github.com/Abinvarghese22",
    color: "#ffffff",
